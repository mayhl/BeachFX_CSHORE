...
from framework.profile import (
    ErosionTick, FullNourishment, PartialNourishment,
    Profile, Recovery, StormResponse,
)
from framework.runner.base import CSHOREResult
from framework.types import SnapshotLabel


def _p(n: int = 100) -> Profile:
    x = np.linspace(0, 200, n)
    return Profile(id="p0", x=x, zb=np.zeros(n), d50=0.3)
