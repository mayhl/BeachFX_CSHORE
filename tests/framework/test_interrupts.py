...
from framework.nourishment import ActiveCampaign, NourishmentConfig, run_campaign
...
def _p(pid: str = "p0", n: int = 50) -> Profile:
    return Profile(id=pid, x=np.linspace(0, 100, n), zb=np.zeros(n), d50=0.3)


def _ncfg(production_rate: float = 500.0) -> NourishmentConfig:
    n = 50
