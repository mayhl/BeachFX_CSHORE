...
# (``Periodic``, ``PeriodicHeld``, ``INUNDATION``, ``RECN``, ``EENS``, ``ESNS``).
# Pinned deliberately: changing a label
...
SNAPSHOT_LABELS = {
    ...
    "PeriodicHeld",  # Python-model: recovery window's held erosion, landing at completion
}
